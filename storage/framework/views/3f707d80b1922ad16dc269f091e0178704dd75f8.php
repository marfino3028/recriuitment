...
<form method="POST" action="<?php echo e(route('jabatan.update',$edit->id)); ?>">
  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Baru\lavsp4\resources\views/jabatan/form_edit.blade.php ENDPATH**/ ?>