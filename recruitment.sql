...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2020 at 12:46 PM
...
INSERT INTO `companies` (`id`, `nama`, `email`, `logo`, `website`) VALUES
(1, 'PT', 'PT@gmail.com', 'fino.png', 'PT.com'),
(2, 'tran', 'tran@gmail.com', 'transisi.png', 'tran.com'),
(3, 'sisi', 'sisi@gmail.com', 'no-photo.jpg', 'sisi');
...
INSERT INTO `employees` (`id`, `nama`, `company_id`, `email`) VALUES
(1, 'transisi', 2, 'transisi@gmail.com'),
(2, 'teknologi', 1, 'teknologi@gmail.com'),
(3, 'mandiri', 3, 'mandiri@gmail.com');
...
(61, 'transisi', 'admin@transisi.id', NULL, '$2y$10$ueGPVPFPAQjpy5Hqmk5/q.eHHDC9bhgDqesiu1IeMLNapKITsX9Du', 'administrator', 'Disetujui', 'transisi.png', NULL, '2020-03-31 06:49:13', '2020-03-31 07:49:13');
